...
export function RoleApiFactory(client: ZetaPushClient): RoleApi {
  return createApi(client, RoleApi) as RoleApi;
}

export const RoleApiProvider = {
  provide: RoleApi, useFactory: RoleApiFactory, deps: [ ZetaPushClient ]
};
